...
def validate_postman_credentials(api_key, workspace_id, collection_id):
	...
	try:
		...
		if collection_response.status_code != 200:
			return {"valid": False, "message": "Invalid collection ID or insufficient permissions"}
...
def get_doctype_fields_for_api(doctype_name):
	...
	try:
		...
		frappe.log_error(f"Error getting fields for {doctype_name}: {e!s}", "Field Info Error")
		return []
